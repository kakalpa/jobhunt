...
- System uptime (99.9%+)
- Performance improvements (load time reduction, query optimization)
- Bug resolution rate and code coverage
- Deployment frequency and CI/CD cycle time reduction

**IT Infrastructure & Systems Administration (Google X-Y-Z):**
- **Fleet Scale:** Number of managed endpoints, servers, or cloud instances (e.g., "200+ multi-OS fleet", "50+ Linux/Windows servers")
- **High Availability & Uptime:** System availability percentages (e.g., "sustained 99.8% server uptime")
- **Automation Impact:** Manual workload reduction (e.g., "reduced manual provisioning time by 40% (60m to 25m)")
- **CMDB Accuracy:** Asset inventory record integrity (e.g., ">95% inventory tracking accuracy")
- **User Population:** Scale of supported end-users across regions (e.g., "300+ international users across US, AU, ZA")

**Cybersecurity & SOC Operations (Google X-Y-Z):**
- **Detection Velocity (MTTD):** Reduction in Mean Time to Detect threats (e.g., "reduced MTTD by 35%")
- **Remediation Speed (MTTR):** Time to contain and eradicate security incidents (e.g., "contained critical host in under 15 minutes")
- **Audit & Framework Compliance:** Compliance audit score (e.g., "100% adherence to ISO 27001 / SOC 2 access control baselines")
- **Telemetry Scale:** Data volume and integrated sources (e.g., "aggregated logs across 50+ enterprise syslog sources")
- **Vulnerability Remediation:** SLA closure rate (e.g., "resolved 100% of Critical CVSS v3 flaws within 7-day SLA")

**Field Service & Desktop Support (Google X-Y-Z):**
- **First-Time-Fix Rate (FTFR):** Percentage of hardware issues resolved on first dispatch (e.g., "94% FTFR across 500+ interventions")
- **Ticket Volume:** Interventions per day/week/month (e.g., "resolved 25+ weekly hardware/connectivity tickets")
- **SLA Compliance:** On-site arrival and closure milestones (e.g., "100% adherence to 15-minute arrival notifications and 30-minute post-service closure")
